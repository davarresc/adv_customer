...
class CustomerPersisterCore
{
    ...
    private function sendConfirmationMail(Customer $customer)
    {
        ...
        $verificationCustomer = (
                Configuration::get('ADV_CUSTOMERS_ENABLE_CUSTOMER') &&
                Configuration::get('ADV_CUSTOMERS_CUSTOMER_REQUIRE_APPROVED') &&
                $customer->type_client === 'customer'
            ) || (
                Configuration::get('ADV_CUSTOMERS_ENABLE_ENTERPRISE') &&
                Configuration::get('ADV_CUSTOMERS_ENTERPRISE_REQUIRE_APPROVED') &&
                $customer->type_client === 'enterprise'
            );
