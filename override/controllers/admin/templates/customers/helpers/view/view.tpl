...
* to license@prestashop.com so we can send you a copy immediately.firstname
            ...
            <div class="col-lg-6">
                <div class="panel clearfix">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="row">
                            <label class="control-label col-lg-3">{l s='Checked' d='Admin.Orderscustomers.Feature'}</label>
                            <div class="col-lg-9">
                                <p class="form-control-static">
                                    {if $customer->is_active}
                                        {l s='Sí' d='Admin.Global'}
                                    {else}
